...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'http://47.106.13.104:3000/movies?movieId=' + options.id,
      data: {},
  ...
  toChooseSeat: function (e) {
    wx.navigateTo({
      url: '../../Pages/select_seat/select_seat?movieId=' + e.currentTarget.dataset.movieid + "&timeId=" + e.currentTarget.dataset.timeid,
    })
